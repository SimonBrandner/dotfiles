...
-- Cornelis (Agda)
vim.keymap.set("n", "<leader>al", ":CornelisLoad<CR>")
vim.keymap.set("n", "<leader>ar", ":CornelisRefine<CR>")
vim.keymap.set("n", "<leader>ac", ":CornelisMakeCase<CR>")
vim.keymap.set("n", "<leader>a,", ":CornelisTypeContext<CR>")
vim.keymap.set("n", "<leader>a.", ":CornelisTypeContextInfer<CR>")
vim.keymap.set("n", "<leader>as", ":CornelisSolve<CR>")
vim.keymap.set("n", "<leader>aa", ":CornelisAuto<CR>")
vim.keymap.set("n", "<leader>ad", ":CornelisGoToDefinition<CR>")
vim.keymap.set("n", "<leader>ap", ":CornelisPrevGoal<CR>")
vim.keymap.set("n", "<leader>an", ":CornelisNextGoal<CR>")
vim.keymap.set("n", "<leader>a+", ":CornelisInc<CR>")
vim.keymap.set("n", "<leader>a-", ":CornelisDec<CR>")
vim.keymap.set("n", "<leader>am", ":CornelisQuestionToMeta<CR>")
vim.keymap.set("n", "<leader>ax", ":CornelisCloseInfoWindows<CR>")
vim.keymap.set("n", "<leader>ag", ":CornelisGive<CR>")
vim.keymap.set("n", "<leader>ae", ":CornelisElaborate<CR>")
vim.keymap.set("n", "<leader>ai", ":CornelisTypeInfer<CR>")
vim.keymap.set("n", "<leader>an", ":CornelisNormalize<CR>")
